...
| Start Iteration 0:
| Iteration 0, Lowest loss: 6.240204674337347
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [2048, 512, 2048, 512, 1024, 2048], 'encoder_self_attention_heads': [2, 2, 4, 2, 4, 2]}, 'decoder': {'decoder_embed_dim': 512, 'decoder_layer_num': 4, 'decoder_ffn_embed_dim': [512, 2048, 1024, 2048, 512, 2048], 'decoder_self_attention_heads': [4, 2, 2, 4, 2, 4], 'decoder_ende_attention_heads': [2, 4, 4, 4, 4, 2], 'decoder_arbitrary_ende_attn': [1, -1, 1, 2, 1, 2]}}
| Predicted latency for lowest loss model: 25.183147192001343
| Start Iteration 1:
| Iteration 1, Lowest loss: 6.208833693753927
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [512, 512, 2048, 2048, 512, 2048], 'encoder_self_attention_heads': [2, 2, 2, 4, 4, 2]}, 'decoder': {'decoder_embed_dim': 512, 'decoder_layer_num': 4, 'decoder_ffn_embed_dim': [512, 512, 2048, 512, 2048, 512], 'decoder_self_attention_heads': [4, 4, 4, 2, 4, 4], 'decoder_ende_attention_heads': [2, 4, 2, 4, 4, 2], 'decoder_arbitrary_ende_attn': [1, 2, -1, 2, 1, 1]}}
| Predicted latency for lowest loss model: 24.77944940328598
| Start Iteration 2:
| Iteration 2, Lowest loss: 6.208414989507307
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [1024, 2048, 512, 512, 512, 512], 'encoder_self_attention_heads': [2, 2, 2, 2, 2, 2]}, 'decoder': {'decoder_embed_dim': 512, 'decoder_layer_num': 4, 'decoder_ffn_embed_dim': [512, 512, 1024, 1024, 1024, 1024], 'decoder_self_attention_heads': [4, 4, 4, 2, 2, 4], 'decoder_ende_attention_heads': [2, 4, 4, 4, 2, 2], 'decoder_arbitrary_ende_attn': [1, 2, -1, 1, 1, -1]}}
| Predicted latency for lowest loss model: 24.21039789915085


config 결과(iwslt14deen_npu@200ms.yml)

encoder-embed-dim-subtransformer: 640
decoder-embed-dim-subtransformer: 512

encoder-ffn-embed-dim-all-subtransformer: [1024, 2048, 512, 512, 512, 512]
decoder-ffn-embed-dim-all-subtransformer: [512, 512, 1024, 1024]

encoder-layer-num-subtransformer: 6
decoder-layer-num-subtransformer: 4

encoder-self-attention-heads-all-subtransformer: [2, 2, 2, 2, 2, 2]
decoder-self-attention-heads-all-subtransformer: [4, 4, 4, 2]
decoder-ende-attention-heads-all-subtransformer: [2, 4, 4, 4]
