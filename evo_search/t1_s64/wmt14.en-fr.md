```
python evo_search.py --configs=configs/wmt14.en-fr/supertransformer/space0.yml --evo-configs=configs/wmt14.en-fr/evo_search/wmt14enfr_npu.yml  --num-workers=8 --cpu
...
| Start Iteration 0:
| epoch 015 | valid on 'valid' subset:   6%|▉              | 19/293 [01:21<19:51,  4.35s/it]| epoch 015 | valid on 'valid' subset:  40%|█████▌        | 116/293 [07:46<11:44,  3.98s/it]| epoch 015 | valid on 'valid' subset:  85%|███████████▉  | 249/293 [10:51<01:25,  1.94s/it]| epoch 015 | valid on 'valid' subset:   2%|▍               | 7/293 [00:25<17:20,  3.64s/it]| epoch 015 | valid on 'valid' subset:   3%|▍               | 8/293 [00:29<18:00,  3.79s/it]| Iteration 0, Lowest loss: 6.912613906174118
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [1024, 1024, 3072, 1024, 1024, 1024], 'encoder_self_attention_heads': [4, 8, 8, 4, 4, 4]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 5, 'decoder_ffn_embed_dim': [1024, 1024, 2048, 2048, 2048, 2048], 'decoder_self_attention_heads': [4, 8, 4, 4, 8, 4], 'decoder_ende_attention_heads': [4, 8, 8, 4, 4, 4], 'decoder_arbitrary_ende_attn': [1, 2, 2, -1, -1, -1]}}
| Predicted latency for lowest loss model: 58.16715359687805
| Start Iteration 1:
| epoch 015 | valid on 'valid' subset:  29%|████▎          | 84/293 [06:23<08:47,  2.53s/it]
```