```sh
| Start Iteration 0:
| Iteration 0, Lowest loss: 7.69311616383158
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 512, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [2048, 2048, 3072, 3072, 1024, 1024], 'encoder_self_attention_heads': [8, 4, 4, 8, 4, 8]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 3, 'decoder_ffn_embed_dim': [1024, 3072, 1024, 3072, 3072, 3072], 'decoder_self_attention_heads': [8, 8, 8, 4, 4, 8], 'decoder_ende_attention_heads': [4, 4, 4, 4, 4, 4], 'decoder_arbitrary_ende_attn': [-1, 2, 2, -1, 1, 2]}}
| Predicted latency for lowest loss model: 2.335638552904129
| Start Iteration 1:
| Iteration 1, Lowest loss: 7.68886948798127
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 512, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [2048, 2048, 3072, 3072, 1024, 3072], 'encoder_self_attention_heads': [8, 4, 4, 4, 4, 8]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 3, 'decoder_ffn_embed_dim': [1024, 3072, 2048, 3072, 3072, 3072], 'decoder_self_attention_heads': [8, 8, 8, 4, 8, 8], 'decoder_ende_attention_heads': [4, 4, 4, 4, 4, 4], 'decoder_arbitrary_ende_attn': [-1, 2, 2, -1, 2, 2]}}
| Predicted latency for lowest loss model: 2.4634167551994324
| Start Iteration 2:
| Iteration 2, Lowest loss: 7.664394872826192
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 512, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [2048, 2048, 3072, 3072, 1024, 1024], 'encoder_self_attention_heads': [4, 4, 4, 4, 4, 8]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 3, 'decoder_ffn_embed_dim': [1024, 3072, 3072, 3072, 1024, 1024], 'decoder_self_attention_heads': [4, 4, 4, 4, 4, 8], 'decoder_ende_attention_heads': [4, 8, 4, 4, 4, 4], 'decoder_arbitrary_ende_attn': [2, 2, 2, -1, 2, -1]}}
| Predicted latency for lowest loss model: 2.4456147104501724
```
```sh
