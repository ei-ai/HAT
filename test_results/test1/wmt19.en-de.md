...
| Start Iteration 0:
| Iteration 0, Lowest loss: 7.405217853575855
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [2048, 3072, 1024, 1024, 2048, 1024], 'encoder_self_attention_heads': [8, 4, 8, 4, 4, 4]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 6, 'decoder_ffn_embed_dim': [1024, 2048, 1024, 3072, 3072, 3072], 'decoder_self_attention_heads': [8, 8, 4, 8, 8, 4], 'decoder_ende_attention_heads': [4, 4, 4, 4, 4, 8], 'decoder_arbitrary_ende_attn': [2, 1, 2, 1, 1, 1]}}
| Predicted latency for lowest loss model: 38.00232112407684
| Start Iteration 1:
| Iteration 1, Lowest loss: 7.320182723457313
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [1024, 1024, 3072, 3072, 3072, 3072], 'encoder_self_attention_heads': [8, 8, 8, 8, 8, 4]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 4, 'decoder_ffn_embed_dim': [3072, 1024, 2048, 3072, 3072, 3072], 'decoder_self_attention_heads': [4, 4, 8, 4, 8, 4], 'decoder_ende_attention_heads': [4, 8, 4, 4, 4, 4], 'decoder_arbitrary_ende_attn': [2, -1, -1, -1, 1, -1]}}
| Predicted latency for lowest loss model: 44.026654958724976
| Start Iteration 2:
| Iteration 2, Lowest loss: 7.277474964307125
| Config for lowest loss model: {'encoder': {'encoder_embed_dim': 640, 'encoder_layer_num': 6, 'encoder_ffn_embed_dim': [1024, 1024, 3072, 3072, 2048, 1024], 'encoder_self_attention_heads': [8, 8, 8, 8, 4, 4]}, 'decoder': {'decoder_embed_dim': 640, 'decoder_layer_num': 4, 'decoder_ffn_embed_dim': [3072, 1024, 2048, 3072, 1024, 1024], 'decoder_self_attention_heads': [4, 4, 8, 4, 4, 4], 'decoder_ende_attention_heads': [4, 4, 8, 8, 4, 4], 'decoder_arbitrary_ende_attn': [-1, 2, 1, 2, -1, -1]}}
| Predicted latency for lowest loss model: 44.73212957382202
```
```
encoder-embed-dim-subtransformer: 640
decoder-embed-dim-subtransformer: 640

encoder-ffn-embed-dim-all-subtransformer: [1024, 1024, 3072, 3072, 2048, 1024]
decoder-ffn-embed-dim-all-subtransformer: [3072, 1024, 2048, 3072]

encoder-layer-num-subtransformer: 6
decoder-layer-num-subtransformer: 4

encoder-self-attention-heads-all-subtransformer: [8, 8, 8, 8, 4, 4]
decoder-self-attention-heads-all-subtransformer: [4, 4, 8, 4]
decoder-ende-attention-heads-all-subtransformer: [4, 4, 8, 8]

decoder-arbitrary-ende-attn-all-subtransformer: [-1, 2, 1, 2]
```